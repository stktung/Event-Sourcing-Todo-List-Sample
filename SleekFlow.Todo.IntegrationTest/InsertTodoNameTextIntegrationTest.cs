...
public class InsertTodoNameTextIntegrationTest : TodoIntegrationTest
{
    [Test]
    ...
    {
        var createResp = await _client.CreateTodoAsync();
        var insertResp1 = (await _client.InsertTodoNameTextAsync(createResp.Id, createResp.LastEventNumber, "testing!", 0)).Response;
        var insertResp2 = (await _client.InsertTodoNameTextAsync(createResp.Id, insertResp1.LastEventNumber, "I'm ", 0)).Response;
        var insertResp3 =
            (await _client.InsertTodoNameTextAsync(createResp.Id, insertResp2.LastEventNumber, "doing some ", 4)).Response;
        var insertResp4 =
            (await _client.InsertTodoNameTextAsync(createResp.Id, insertResp3.LastEventNumber, " Good work!", 23)).Response;
    ...
    {
        var insertResp = await _client.InsertTodoNameTextAsync(Guid.NewGuid(), 0, "Testing", 0);
    ...
    {
        var insertResp = await _client.InsertTodoNameTextAsync(Guid.NewGuid(), 0, string.Empty, 0, string.Empty);
    ...
    {
        var createResp = await _client.CreateTodoAsync();
        var insertResp1 = await _client.InsertTodoNameTextAsync(createResp.Id, -1, string.Empty, 0);
        var insertResp2 = await _client.InsertTodoNameTextAsync(createResp.Id, 1, string.Empty, 0);
    ...
    {
        var createResp = await _client.CreateTodoAsync();
        var insertResp1 = await _client.InsertTodoNameTextAsync(createResp.Id, 0, string.Empty, -1);
        var insertResp2 = await _client.InsertTodoNameTextAsync(createResp.Id, 0, string.Empty, 1);
