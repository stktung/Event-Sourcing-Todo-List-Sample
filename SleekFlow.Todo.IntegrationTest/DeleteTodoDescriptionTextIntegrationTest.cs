...
public class DeleteTodoDescriptionTextIntegrationTest : TodoIntegrationTest
{
    [Test]
    public async Task TodoController_DeleteTodoDescriptionText_Simple_Returns_Todo_With_Text_After_Deletion()
    {
        ...
        var deleteTodoDescriptionTextAsync = (await _client.DeleteTodoDescriptionTextAsync(createResp.Id, insertResp.LastEventNumber, 4, 3));
        var deleteResp1 = deleteTodoDescriptionTextAsync.Response;
        ...
        var deleteResp2 = (await _client.DeleteTodoDescriptionTextAsync(createResp.Id, deleteResp1.LastEventNumber, 4, 1)).Response;
        ...
        var deleteResp3 = (await _client.DeleteTodoDescriptionTextAsync(createResp.Id, deleteResp2.LastEventNumber, 0, 4)).Response;
        ...
        Assert.That(todo1.Description, Is.EqualTo("Test!"));
        ...
        Assert.That(todo2.Description, Is.EqualTo("Test"));
        ...
        Assert.That(todo3.Description, Is.EqualTo(string.Empty));
    ...
    [Test]
    public async Task TodoController_DeleteTodoDescriptionText_With_Unknown_Id_Returns_404()
    {
        var resp = await _client.DeleteTodoDescriptionTextAsync(Guid.NewGuid(), 0, 0, 0);

        Assert.That(resp.HttpResponse.StatusCode, Is.EqualTo(HttpStatusCode.NotFound));
    }

    [Test]
    public async Task TodoController_DeleteTodoDescriptionText_With_Missing_Body_Returns_400()
    {
        var resp = await _client.DeleteTodoDescriptionTextAsync(Guid.NewGuid(), 0, 0, 0, string.Empty);

        Assert.That(resp.HttpResponse.StatusCode, Is.EqualTo(HttpStatusCode.BadRequest));
    }

    [Test]
    public async Task TodoController_DeleteTodoDescriptionText_With_Mismatched_Version_Returns_400()
    {
        var createResp = await _client.CreateTodoAsync();
        var deleteResp1 = await _client.DeleteTodoDescriptionTextAsync(createResp.Id, -1, 0, 0);
        var deleteResp2 = await _client.DeleteTodoDescriptionTextAsync(createResp.Id, 1, 0, 0);
    ...
    [Test]
    public async Task TodoController_DeleteTodoDescriptionText_With_Invalid_Position_Returns_400()
    {
        var createResp = await _client.CreateTodoAsync();
        var insertResp = await _client.InsertTodoDescriptionTextAsync(createResp.Id, createResp.LastEventNumber, "Testing!", 0);
        var deleteResp1 = await _client.DeleteTodoDescriptionTextAsync(createResp.Id, insertResp.Response.LastEventNumber, -1, 0);
        var deleteResp2 = await _client.DeleteTodoDescriptionTextAsync(createResp.Id, insertResp.Response.LastEventNumber, 9, 0);
    ...
    [Test]
    public async Task TodoController_DeleteTodoDescriptionText_Beyond_Current_Text_Returns_400()
    {
        var createResp = await _client.CreateTodoAsync();
        var insertResp = await _client.InsertTodoDescriptionTextAsync(createResp.Id, createResp.LastEventNumber, "Testing!", 0);
        var deleteResp1 = await _client.DeleteTodoDescriptionTextAsync(createResp.Id, insertResp.Response.LastEventNumber, 0, 9);
